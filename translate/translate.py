...
coner_tags =["B-LOC", "E-LOC", "B-CW", "E-CW",
             "B-GRP", "E-GRP", "B-PER", "E-PER",
             "B-PROD", "E-PROD", "B-MED", "E-MED"]
coner_tags_quotes =["B-LOC\"", "E-LOC\"", "S-LOC\"", "I-LOC\"",
                    "B-CW\"", "E-CW\"", "S-CW\"", "I-CW\"",
                    "B-GRP\"", "E-GRP\"", "S-GRP\"", "I-GRP\"",
                    "B-PER\"", "E-PER\"", "S-PER\"", "I-PER\"",
                    "B-PROD\"", "E-PROD\"", "S-PROD\"", "I-PROD\"",
                    "B-MED\"", "E-MED\"", "S-MED\"", "I-MED\""]
...
def preproess_coner(sentence):
    ...
    if sentence == '':
        ...
        print("priginal sentence: ",original_string)
...
fpath = 'mulda-coner-en-test.txt'
#ofpath = tl+'.train.new.link.txt'
ofpath = tl+'.mulda.coner.new.link.txt'
run(fpath, ofpath)
