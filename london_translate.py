...
JSON_FILE_NAME = "london_results.json"
SKIPPED_FILE_NAME = "london_skipped.csv"
JSON_FILE = f"{OUTPUT_FOLDER}/{JSON_FILE_NAME}"
SKIPPED_FILE = f"{OUTPUT_FOLDER}/{SKIPPED_FILE_NAME}"
UNTRANSLATED_CONLL_FILE_NAME = f"{SOURCE_LANGUAGE}-{TARGET_LANGUAGE}-orig-london.conll"
TRANSLATED_CONLL_FILE_NAME = f"{SOURCE_LANGUAGE}-{TARGET_LANGUAGE}-trans-london.conll"
